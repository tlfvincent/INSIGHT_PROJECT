...
The first analysis we can run is to check the overall relationship movie box office revenue and allocated budget. We can observe a very strong linear relationsip between these two variables. 
